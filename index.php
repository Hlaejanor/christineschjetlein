            ...
            <div class="slider_wrap slider_fullwide slider_engine_revo slider_alias_home-1">
                <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper rev_slider_wrapper11 fullwidthbanner-container">
                    <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" data-version="5.2.6">
                        <ul>
                            <!-- slide-1 -->
                            <li data-index="rs-1" data-transition="fade,crossfade" data-slotamount="default,default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default,default" data-easeout="default,default" data-masterspeed="1000,default" data-thumb="images/slide1-100x50.jpg" data-rotate="0,0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                <img src="images/blomst_asfalt_stor_header.jpg" alt="" title="Lås" width="4800" height="2000" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                <div class="tp-caption home_1_subtitle home_1_subtitle11 tp-resizeme" id="slide-1-layer-1" data-x="10" data-y="160" data-width="['auto']" data-height="['auto']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:1000;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;" data-start="750" data-splitin="none" data-splitout="none" data-responsive_offset="on">
                                  Inspirasjon til å gjenvinne livskraft
                                </div>
                                ...
                                “Christine skaper nok trygghet til at jeg tør utforske <br>det utrygge. Det var der utviklingen skjedde”
                                    <span class="attribution">Olav Lund, Lege</span>
                                </div>
                                <a    href="referanser.php" class="post_readmore sc_button sc_button_style_filled sc_button_center"
                            ...
                            <div class="sc_services sc_services_style_services-4 sc_services_type_icons cd_accent1_hover margin_top_huge margin_bottom_huge">
                                <h1 class="home_h2 sc_services_title sc_item_title " style="text-align:center;">Dine muligheter</h1>
                                        ...
                                        <div class="column-1_2 col_right">
                                          <div class="sc_services_item sc_services_item_3 odd">
                                              <a href="psykoterapi.php">
                                                  <span class="sc_icon icon-check71"></span>
                                                  <span class="sc_services_item_title">
                                                  Nevrovitenskap - lær mindfulness
                                                  </span>
                                              </a>
                                          </div>
                                        </div>
                                    ...
                                    <div class="sc_services_button sc_item_button">
                                        <a href="psykoterapi.php" class="sc_button sc_button_square sc_button_style_filled   sc_button_size_small">
                                        Utforsk mer
                                      </a>
                                    </div>
                                </div>
                            ...
                            <div class="sc_content content_wrap">
                                <div class="columns_wrap sc_columns columns_nofluid autoheight sc_columns_count_12">
                                    <div class="column-5_12 sc_column_item sc_column_item_1 odd first span_5">
                                        <div class="about_img">
                                            <img src="images/christine2.jpeg" height="500px" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="sc_section_inner">
                                                <div class="sc_section_content_wrap">
                                                    ...
                                                    <div class="expert_clinical">
                                                       Psykoterapeut, Coach & Kursholder
                                                    </div>
                                                                            ...
                                                                            <div class="sc_services_item_featured post_featured">
                                                                                <div class="post_thumb" data-title="Mindfulness">
                                                                                    <a class="hover_icon hover_icon_link" href="coaching.php#mindfulness">
                                                                                        <img alt="Mindfulness" src="images/bilde-mane.jpg">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="sc_services_item_featured post_featured">
                                                                                <div class="post_thumb" data-title="Psykoterapi">
                                                                                    <a class="hover_icon hover_icon_link" href="psykoterapi.php">
                                                                                        <img alt="Psykoterapi" src="images/bilde-8.jpg">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sc_services_item_content">
                                                                                ...
                                                                                <div class="sc_services_item_description">
                                                                                    <p>Prosessen i psykoterapi er et grunnleggende sorteringsarbeid, som øker din selvinnsikt og livskompetanse. </p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="sc_services_item_featured post_featured">
                                                                                <div class="post_thumb" data-title="Coaching">
                                                                                    <a class="hover_icon hover_icon_link" href="coaching.php">
                                                                                        <img alt="Coaching" src="images/bilde-7.jpg">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="sc_services_item_content">
                                                                ...
                                                                <!-- swiper-slide -->
                                                                    ...
                                                                    <div class="sc_services_item_wrap">
                                                                        <div class="sc_services_item sc_services_item_2 even">
                                                                            ...
                                                                            <div class="sc_services_item_content">
                                                                                <h4 class="sc_services_item_title">
                                                                                    <a href="kurs.php">Kvinnekurs</a>
                                                                                </h4>
                                                                                <div class="sc_services_item_description">
                                                                                    <p>Kun i samvær med andre kvinner kan vi (gjen)oppdage det feminine feltet i oss selv, slik kvinnefelleskap har vært praktiserte i uminnelige tider. </p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="sc_slider_swiper swiper-slider-container sc_slider_pagination sc_slider_pagination_bottom sc_slider_nocontrols" data-interval="9020" data-slides-per-view="2" data-slides-space="30" data-slides-min-width="250">
                                                    <div class="slides swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="sc_testimonial_item">
                                                                <div class="sc_testimonial_content">
                                                                    <p>Jeg kan skrive under på verdien av en god veileder i livet – om man skal ta skrittet og våge å ta inn over seg realitetene ved vår eksistens! Christine er intelligent, klok, proppfull av humor og besitter et vell av verktøy som gir perspektiver til livet.... </p>
                                                                </div>
                                                                <div class="sc_testimonial_avatar">
